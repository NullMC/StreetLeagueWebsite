    ...
    benefits: [
      ...
      <>
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <strong style={{ color: "#F1CF18" }}>
            grafiche, montaggio video e branding
          </strong>
        </a>
      </>,
    ],
              ...
              >
                <div className="sponsorship-card__top">
                  ...
                  <strong className="sponsorship-card__price">
                    <span className="sponsorship-card__price-value">
                      {pkg.price}
                    </span>
                    <span className="sponsorship-card__price-currency">€</span>
                  </strong>
                </div>
        ...
        <div className="collaborate-container">
          <div className="collaborate-cta">
            <div>
              ...
              <p>
                Scegli il livello di partnership più adatto alla tua attività e
                porta il tuo brand all’interno della Street League.
              </p>
            </div>
            <a
