...
import { getAuthenticatedAdmin, signInWithAccessCode, type AdminProfile } from "../lib/admin";
...
const fields: Record<Resource, string[]> = {
  ...
  players: ["team_id", "first_name", "last_name", "shirt_number", "position"],
...
const fieldLabels: Record<string, string> = {
  ...
  team_id: "Squadra", first_name: "Nome", last_name: "Cognome", shirt_number: "Numero", position: "Ruolo",
